...
class TestAttachmentSupport:
    ...
    def test_get_article_attachments(self) -> None:
        ...
        # Verify we can create Attachment objects from the data
        attachments = [Attachment(**attachment) for attachment in result]
    ...
    def test_download_attachment(self) -> None:
        ...
        # Verify base64 encoding works as expected
        expected = base64.b64encode(result).decode("utf-8")
        assert expected == "ZmlsZSBjb250ZW50"  # base64 of "file content"
